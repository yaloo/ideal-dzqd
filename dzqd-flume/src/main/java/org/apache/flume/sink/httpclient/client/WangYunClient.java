...
public class WangYunClient implements HttpClient {
  private static final Logger LOGGER = LoggerFactory.getLogger(WangYunClient.class);
  ...
  public void configure(Context context) {
    ...
    while (it.hasNext()){
      list.add(new BasicHeader(it.next(),map.get(it.next())));
    }

    list.add(new BasicHeader("Content-type","application/X-aims-OctetFile;charset=utf-8"));
    list.add(new BasicHeader("EsTag","ABC09K8989KKHLJ8000HLIJUFKUJLJHU"));
